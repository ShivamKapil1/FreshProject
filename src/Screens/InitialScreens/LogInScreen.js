  ...
  render() {
    ...
    <View style={{ flex: 1, backgroundColor:'indigo'}}>
      ...
      <View style={{ flex: 2, justifyContent: 'center', alignItems:'center'}}>
          <Text style={{color:'white',fontSize:20}}>(Scholar Icon here)</Text>
          <Text style={{color:'white',fontSize:30}}>ACCESS</Text>
          <Text style={{color:'white',fontWeight: 'bold', fontSize:35}}>PGMEE</Text>
      </View>
